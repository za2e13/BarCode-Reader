...
class ViewController: UIViewController {
    ...
    @IBAction func findWeather(sender: AnyObject) {
        ...
        if url != nil{
            ...
            let task = NSURLSession.sharedSession().dataTaskWithURL(url!, completionHandler: {(data, responce, error)-> Void in
                ...
                dispatch_async(dispatch_get_main_queue()){
                    ...
                    if urlError == true {
                        ...
                        self.resultLabel.text = "Today \(self.userCity.text) weather is " + weather
                    }
                }
            })
